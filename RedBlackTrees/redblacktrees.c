...
static size_t __red_black_tree_number_entries_aux(
  const tree_node_t *node)
{
  size_t l, r;
...
static size_t __red_black_tree_height_aux(
  const tree_node_t *node)
{
  size_t l, r;
...
static void __red_black_delete_fixup(
  red_black_tree_t *tree, tree_node_t *x)
{
  tree_node_t *w;
